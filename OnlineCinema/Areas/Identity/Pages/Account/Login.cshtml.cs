...
namespace OnlineCinema.Areas.Identity.Pages.Account
{
                ...
                if (result.Succeeded)
                {
                   // await _roleManager.CreateAsync(new IdentityRole { Name = "Moderator" });
                    /* await _roleManager.CreateAsync(new IdentityRole { Name = "Administrator" });
                     var a = await _userManager.FindByEmailAsync(Input.Email);
                     await _userManager.AddToRoleAsync(a, "Administrator");*/
