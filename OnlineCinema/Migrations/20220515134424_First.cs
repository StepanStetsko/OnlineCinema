        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Persons_PersonInfos_PersonInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenreSeason", x => new { x.GenresId, x.RelationshipsId });
                    table.ForeignKey(
                        name: "FK_GenreSeason_Genres_GenresId",
                        column: x => x.GenresId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreSeason_Seasons_RelationshipsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movies_Seasons_SeasonId",
                        column: x => x.SeasonId,
                        principalTable: "Seasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoCatalogId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonSeason", x => new { x.CastId, x.VideoCatalogId });
                    table.ForeignKey(
                        name: "FK_PersonSeason_Persons_CastId",
                        column: x => x.CastId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonSeason_Seasons_VideoCatalogId",
                        column: x => x.VideoCatalogId,
                        principalTable: "Seasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreSeason_RelationshipsId",
                table: "GenreSeason",
                column: "RelationshipsId");

            migrationBuilder.CreateIndex(
                name: "IX_Movies_SeasonId",
                table: "Movies",
                column: "SeasonId");

            migrationBuilder.CreateIndex(
                name: "IX_Persons_PersonInfoId",
                table: "Persons",
                column: "PersonInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_PersonSeason_VideoCatalogId",
                table: "PersonSeason",
                column: "VideoCatalogId");
